      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 md:grid-cols-2">
        ...
        >
          ...
          <p className="mb-6 text-base leading-8 text-gray-600">
            ...
            lucratif créée le 5 juin 2022 par Madame Maria Mobari EKOLOANE.

            Elle œuvre pour promouvoir la solidarité, l'inclusion sociale,
          ...
          <p className="mb-8 text-base leading-8 text-gray-600">
            ...
            À travers ses actions humanitaires, ses programmes de formation
            et ses initiatives communautaires, la Fondation accompagne les
            personnes vulnérables afin de restaurer leur dignité et créer
