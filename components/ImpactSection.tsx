...
const impacts = [
...

  {
    ...
    description:
      "Un engagement continu pour améliorer les conditions de vie.",
    icon: HandHeart,
  },
];
...
export default function ImpactSection() {
  return (
    <section className="relative overflow-hidden bg-black px-6 py-24 text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black via-black/90 to-yellow-900/20" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="leading-8 text-gray-300">
            ...
            Grâce à l'engagement de nos bénévoles, partenaires et donateurs,
            la Fondation Mobari Maria travaille chaque jour à restaurer la
            dignité et créer de nouvelles opportunités.
          ...
          {impacts.map((item, index) => {
            ...
            return (
              ...
              <motion.div
                ...
                className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-sm transition hover:-translate-y-2 hover:bg-white/10"
              ...
              >
                ...
                <h3 className="mb-3 text-4xl font-extrabold text-yellow-400">
